...
const PRODUCT_LIST = [
  {
    ...
    image_urls: [
      ...
      {
        category1: "LP",
        image_url: SETTING_DOMAIN_URL + "/access_form_sample/商品圖/薰衣草紫.jpg",
      },
      {
        category1: "SL",
      ...
      {
        category1: "CP",
        image_url: SETTING_DOMAIN_URL + "/access_form_sample/商品圖/珊瑚粉.png",
      },
      {
        category1: "CB",
        image_url: SETTING_DOMAIN_URL + "/access_form_sample/商品圖/可可棕.png",
      },
    ],
  },
  // 可複數
